...
extern void *mono_aot_module_AppAzureAuditoria_info;
...
{
	mono_aot_register_module (mono_aot_module_AppAzureAuditoria_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "AppAzureAuditoria.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
